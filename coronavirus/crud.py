...
LastEditors: Bowen
Description: 
FilePath: /fastapi-tutorial/coronavirus/crud.py
'''
...
def get_data(db: Session, city: str = None, skip: int = 0, limit: int = 10):
    if city:
        return db.query(models.Data).filter(models.Data.city.has(province=city))  # 外键查询，这里不是像 Django ORM 那样 Data.city.province
